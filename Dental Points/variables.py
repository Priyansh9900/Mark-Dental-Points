...
PIXEL_FOR_22MM = 22 * PIXEL_PER_MM  # d
d2 = 1 * PIXEL_PER_MM
...
cos_slope6_per = 1 / math.sqrt(1 + (slope6_perpendicular) ** 2)
sin_slope6_per = slope6_perpendicular / math.sqrt(1 + (slope6_perpendicular) ** 2)
...
y_per = slope6_perpendicular * x_per + M6_y - slope6_perpendicular * M6_x
...
m2, c2 = slope6_perpendicular, M6_y - slope6_perpendicular * M6_x
c_x = (c1 - c2) / (m2 - m1)
c_y = m1 * c_x + c1
